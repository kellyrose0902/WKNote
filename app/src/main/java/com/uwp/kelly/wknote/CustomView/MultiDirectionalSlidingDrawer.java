...
public class MultiDirectionalSlidingDrawer extends ViewGroup {
     ...
     */
    public MultiDirectionalSlidingDrawer( Context context, AttributeSet attrs )
    {
     ...
     */
    public MultiDirectionalSlidingDrawer( Context context, AttributeSet attrs, int defStyle )
    {
                ...
                case MotionEvent.ACTION_CANCEL: {
                    ...
                    if ( Math.abs( velocity ) < mMaximumTapVelocity ) {
                        ...
                        if( mInvert ) {
                            ...
                            c4 = ( !mExpanded && handleRight < mTopOffset + mHandleWidth - mTapThreshold );
                        } else {
